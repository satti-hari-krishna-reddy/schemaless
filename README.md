...
If you want **NEW** automatic translations, it requires an API-key for any LLM provider. Defaults to OpenAI. This is **not** required for existing translations.
```
export AI_API_KEY=your_key
export AI_API_URL=https://your-provider
```
